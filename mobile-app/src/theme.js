...
function makeLightTheme(name, overrides = {}) {
  ...
  return {
    ...
    colors: {
      ...
      textMuted: overrides.textMuted || '#81929F',
      ...
      error: '#E35B5B',
      info: '#3288F5',
      gradientStart: overrides.gradientStart || primaryLight,
      ...
      placeholder: overrides.placeholder || '#8A9AA8',
...
function makeDarkTheme(name, overrides = {}) {
  ...
  return {
    ...
    colors: {
      ...
      textMuted: overrides.textMuted || '#7A8999',
      ...
      placeholder: overrides.placeholder || '#6E8090',
