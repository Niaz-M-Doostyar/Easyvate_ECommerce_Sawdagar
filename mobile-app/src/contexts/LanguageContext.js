...
const translations = {
  en: {
    ...
    registrationVerifyMessageSupplier: 'Your supplier account has been created. Please verify your email first, then log in.',
  ...
  ps: {
    ...
    registrationVerifyMessageSupplier: 'ستاسو د عرضه کوونکي حساب جوړ شو. مهرباني وکړئ لومړی خپل برېښنالیک تایید کړئ، بیا ننوتل وکړئ.',
  ...
  dr: {
    ...
    registrationVerifyMessageSupplier: 'حساب تامین‌کننده شما ساخته شد. لطفا ابتدا ایمیل خود را تایید کنید و سپس وارد شوید.',
