...
const translations = {
  en: {
    ...
    search: 'Search products...', searchTitle: 'Search', addToCart: 'Add to Cart', add: 'Add', soldOut: 'Sold out', buyNow: 'Buy Now',
    ...
    registrationVerifyMessageSupplier: 'Your supplier account has been created. Verify your email, then wait for admin approval before logging in.',
  ...
  ps: {
    ...
    search: 'محصولات لټول...', searchTitle: 'لټون', addToCart: 'کارټ ته اضافه کړئ', add: 'زیاتول', soldOut: 'خلاص', buyNow: 'اوس واخلئ',
    ...
    registrationVerifyMessageSupplier: 'ستاسو د عرضه کوونکي حساب جوړ شو. برېښنالیک تایید کړئ، بیا د ننوتلو مخکې د اډمین تایید ته انتظار وکړئ.',
  ...
  dr: {
    ...
    search: 'جستجوی محصولات...', searchTitle: 'جستجو', addToCart: 'افزودن به سبد', add: 'افزودن', soldOut: 'تمام', buyNow: 'خرید فوری',
    ...
    registrationVerifyMessageSupplier: 'حساب تامین‌کننده شما ساخته شد. ایمیل را تایید کنید، سپس پیش از ورود منتظر تایید مدیر بمانید.',
